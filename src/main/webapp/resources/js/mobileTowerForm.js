...
$( document ).ready( function () {
	...
	var validator = $( "#formId" ).validate({
		...
		rules: {
			...
			mobileTowerSize : {
				required: true, digits: true, maxlength: 3 , minlength: 2
			},
			department_id: {
				required: true, min: 1
			},
		...
		messages: {
			...
			plot_flat_no: {
				...
				maxlength: "Plot/Flat No./Door No./House No. should not exceed 25 characters!"
			},
			bldg_house_num: {
				required: "This field is required!",
			...
			bldg_height: {
				...
				maxlength: "Height of building should not exceed {0} characters!"
			},
			bldg_stores: {
				required: "This field is required!",
				min: "This field is required!",
