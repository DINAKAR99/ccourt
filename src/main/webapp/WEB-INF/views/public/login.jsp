			...
			<c:if test="${not empty errorMessageForUsercaptcha}">
				...
				<div class="mt-5 d-flex justify-content-center d-none" id="captchadiv">
					<div class=" text-center border rounded rounded-5 border-1 border-black py-3 w-50 text-white "
						...
						${errorMessageForUsercaptcha}</div>
				</div>
			</c:if>
			<div class="container-fluid my-5 logpage pr-5">

				<div class="col-5 offset-7  p-4 shadow shadow-lg bg-light border  "
					...
					<div class="">
						...
						<c:if test="${not empty errorMessge}">
							<div class="errorMessageForInvalidCredentials">
								<span id="errorMessageForInvalidCredentialsMessage"
									style="color: red">${errorMessge}</span>
							</div>
						</c:if>
						<form id="loginFormId" class="applicantForm" method="post" action="login" autocomplete="off">
							<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
							<!-- <span id="errorMessageForApplicantName" style="color: red"></span> -->
							<div class="form-group input-group">
								<div class="input-group-prepend">
									<span class="input-group-text"
										style="border-radius: 0px;padding-right: 15px;padding-left: 14px;"><i
											class="fa fa-user"></i></span>
								</div>
								<input type="text" class="form-control applicantLoginInput userNameForApplicant"
									placeholder="User Id" name="username" id="username" required="required">
							</div>
							<!-- <span id="errorMessageForApplicantPassword" style="color: red"></span> -->
							<div class="form-group input-group  ">

								<div class="form-group input-group" style="display: flex; width: 100%;">
									<div class="input-group-prepend">
									...
									<div style="flex-grow: 1;">
										<input type="password" class="form-control passwordForApplicant"
											style="border-bottom-left-radius: 0; border-top-left-radius: 0;padding-right: 40px;"
											placeholder="Password" name="password" required="required"
											id="passwordInput">
										<span class="fa fa-fw fa-eye-slash field-icon" id="eyeIcon"
							...
							<div class="form-group   d-flex">
								<label for="user_captcha" class="col-sm-5 col-form-label "
									style="padding-right: 0px;padding-top: 0px;">

									<canvas id="textCanvas2" height="25" style="height: 40px;"></canvas> <img
										style="height: 40px; width: 110px;" id='captchaImage2' alt="Captcha Image"
										draggable="false" />
									<button type="button" class="btn btn-outline-info px-2 pt-0 pb-0"
										onClick="fetchCaptcha();">
										<i class="fa fa-refresh " aria-hidden="true"></i>
									</button>
								</label>
								<input name="captcha" required="required" type="text" id="captchaInput2"
									class="inputbox col-sm-7 form-control" placeholder="Enter CAPTCHA"
									style="padding-right: 8px;" />

							</div>

							<div class="form-group text-center">
								<button type="submit" class="btn btn-success text-light font-weight-normal">
							...
							<div class="row">
								...
								<div class="col-6">
									<div class="form-group text-center">
										<a href="public/forgotPassword" class="font-weight-bold"
								...
								<div class="col-6">
									...
									<div class="form-group text-center">
										Don't have an account? <a href="public/userRegistration"
											class="font-weight-bold" id="signup">Register</a>
									</div>
						...
						function () {
							...
							$('#captchaInput2').keyup(
								function () {
									...
									var captcha = $("#captchaInput2").val()
										.toUpperCase();

									$("#captchaInput2").val(captcha);
								});

							var validator = $("#loginFormId")
								.validate(
									{
										onkeyup: false,
										validClass: "is-valid",
										...
										messages: {
											username: {
												...
												userTypeCheck: "User not found or not accessible!"
											},
											password: {
												required: "This field is required!",
											},
										...
										invalidHandler: function (event,
											...
											var errors = validator
												.numberOfInvalids(); // Number Of Invalid fields
											console
												.log("Number of Invalid Fields: "
													+ errors);
										},
